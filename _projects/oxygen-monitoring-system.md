...
The monitoring system uses multiple communication layers:

- RS485 Modbus RTU for communication between controllers.
- Ethernet Modbus TCP/IP for transmitting data to a PC web server.
- I2C communication for the local 1602 LCD display.
